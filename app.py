...
# Download the model at runtime (for Streamlit Cloud compatibility)
def get_nlp_model():
    try:
...
st.markdown("Enter English text (including Indian names). This app extracts **People**, **Locations**, and **Organizations** using spaCy.")
